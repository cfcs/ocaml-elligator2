...
let test_hash_to_curve_kleshni () =
  ...
  *)
  let check_decode s ~point (rep:string) =
    Alcotest.(check @@ z)
      s (of_bits_le point)
      (Elligator.crypto_hidden_to_curve rep |> Fe.to_z) (* u *)
  in
  ...
  Alcotest.(check @@ pair z z)
    ...
    (Z.one, of_bits_le "\x10\x74\x54\x97\xd3\x5c\x6e\xde\x6e\xa6\xb3\x30\x54\x6a\x6f\xcb\xf1\x5c\x90\x3a\x7b\xe2\x8a\xe6\x9b\x1c\xa1\x4e\x0b\xf0\x9b\x60")
    (Elligator.fast_hash_to_curve (of_bits_le "\x17\x9f\x24\x73\x0d\xed\x2c\xe3\x17\x39\x08\xec\x61\x96\x46\x53\xb8\x02\x7e\x38\x3f\x40\x34\x6c\x1c\x9b\x4d\x2b\xdb\x1d\xb7\x6c") |> fun (u,w) -> Fe.to_z u, Fe.to_z w)
...
let tests = [
  ...
  "selftest", [
    ...
    "hash_to_curve:kleshni", `Quick, test_hash_to_curve_kleshni ;
